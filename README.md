...
4. add the lines in the `.zshrc` file in this repository to your `.zshrc` file
5. append the configuration in the `options.lua` file in this repository to `~/.config/nvim/lua/config/options.lua`
